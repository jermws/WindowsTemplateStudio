...
{
    public class OCRPageViewModel : ViewModelBase
    {
        /// <summary>
        /// The _contact repository
        /// </summary>
        private readonly ICognitiveServicesVisionRepository<TextImageResponse> cognitiveServicesVisionRepository;

        private TextImageResponse _imageResponse;
        ...
        public OCRPageViewModel(ICognitiveServicesVisionRepository<TextImageResponse> cognitiveServicesVisionRepository)
        {
        ...
        private void FormatResponse(TextImageResponse imageResponse)
        {
            StringBuilder sbText = new StringBuilder();


            if (imageResponse != null && imageResponse.regions != null)
            {
                foreach (var regions in imageResponse.regions)
                {
