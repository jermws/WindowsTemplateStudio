...
using CognitiveServicesUWP.Helpers;
...
namespace CognitiveServicesUWP.ViewModels
{
    public class ShellViewModel : ViewModelBase
    {
        ...
        private void PopulateNavItems()
        {
            ...
            PrimaryItems.Add(new ShellNavigationItem("Shell_Vision".GetLocalized(), Symbol.Document, "Vision"));
            PrimaryItems.Add(new ShellNavigationItem("Shell_OCR".GetLocalized(), Symbol.Document, "OCR"));
            PrimaryItems.Add(new ShellNavigationItem("Shell_HandWriting".GetLocalized(), Symbol.Document, "HandWriting"));
        }
